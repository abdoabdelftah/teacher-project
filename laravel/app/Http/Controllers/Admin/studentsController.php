...
class studentsController extends Controller
{
    ...
    {
        $data = User::with('grade')->orderBy('id', 'desc')->paginate('10');
    ...
    public function newmonth($id)
    {
        ...
        if (!$student)
            ...
            $subscription_end_date = Carbon::create($student->subscription_end_date)->addMonth();
   ...
   $unitname = Unitexamsectionfollowup::with('unitexamsection:id,name', 'studentanswer:unit_exam_section_id,points,student_id', 'exam:unit_exam_section_id,points')->where('student_id', $id)->get();
    ...
    public function edit($id)
    {
      ...
      $grades = Grade::get();
        ...
        return view('admin.editstudent', compact('data', 'grades'));
