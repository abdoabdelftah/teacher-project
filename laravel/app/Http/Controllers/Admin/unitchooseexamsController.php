...
class unitchooseexamsController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $data = Exam::where('unit_exam_section_id', $id)->where('type' , '3')->get();
   
        return view('admin.unitchooseexams', compact('data', 'unitexamsection', 'unit', 'grade'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $examid = Exam::max('id');
        return redirect('admin/unitchooseexams/edit/'.$examid)->with(['message' => 'قم باكمال متطلبات السؤال  ']);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.addunitchooseexam', compact('mainid', 'unitexamsection', 'unit', 'grade'));
    }
    ...
    public function edit($id)
    {
        ...
        $grade = Grade::where('id', $unit->grade_id)->first();
      //return $data;
        return view('admin.editunitchooseexam', compact('data', 'unitexamsection', 'unit', 'grade'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('admin/unitchooseexams/'.$exam->unit_exam_section_id)->with(['message' => ' تم التحديث بنجاح ']);
