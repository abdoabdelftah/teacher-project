                ...
                <div class="template-demo">
                  ...
                  <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb breadcrumb-custom">
                      ...
                      <li class="breadcrumb-item"><a href="{{url('student/forums')}}">الاسئلة الخاصة بك</a></li>
...
@if($data->student_id == auth()->user()->id && $data->is_closed == 0)
  <div class="col-md-12 grid-margin">
    <div class="card">
      <div class="card-body">

        <form method="POST" class="pt-3" enctype="multipart/form-data" action="{{ route('add.comment') }}">
          @csrf
