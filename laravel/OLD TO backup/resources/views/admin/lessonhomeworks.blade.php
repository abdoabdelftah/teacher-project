...
<a href="{{url('admin/addlessonhomework/'.$urlid)}}" class="btn btn-success">اضافة سؤال</a>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{url('admin/lessonhomeworks/edit/'.$dat -> id)}}" class="btn btn-outline-primary">  تعديل السؤال</a>
                            </td>
