  ...
  <div class="template-demo">
    ...
    <nav aria-label="breadcrumb" role="navigation">
      <ol class="breadcrumb breadcrumb-custom">
        ...
        <li class="breadcrumb-item"><a href="{{url('admin/lessonexams/'.$lessonsection->id)}}">{{$lessonsection->name}}</a></li>
        ...
        <li class="breadcrumb-item active" aria-current="page"><span>اضافة سؤال</span></li>
                    ...
                    <form method="POST" class="pt-3" action="{{ route('store.lessonexam') }}">
                      @csrf
