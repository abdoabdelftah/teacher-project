    ...
    <div class="container-scroller">
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          ...
          <a class="navbar-brand brand-logo-mini" href="<?php echo e(url('/admin/students')); ?>"><img src="<?php echo e(asset('assets/images/test.png')); ?>" alt="logo" /></a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('admin/allforums')); ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('admin/unit/notcorrected')); ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('admin/lesson/notcorrected')); ?>">
...
<?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>