  ...
  <div class="template-demo">
    ...
    <nav aria-label="breadcrumb" role="navigation">
      <ol class="breadcrumb breadcrumb-custom">
        ...
        <li class="breadcrumb-item active" aria-current="page"><span>تعديل امتحان وحدة</span></li>
                    ...
                    <form method="POST" class="pt-3" action="<?php echo e(route('update.unitexamsection')); ?>">
                      <?php echo csrf_field(); ?>
                   ...
                   <!--  <div class="form-group">
                      ...
                      <input type="number" name="stop_watch" class="form-control" value="" aria-label="Username">
                    </div> -->
                   ...
                   <!-- <div class="form-group">
                      ...
                      <input type="number" name="answer_time" class="form-control" value="" aria-label="Username">
                    </div> -->
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/admin/editunitexamsection.blade.php ENDPATH**/ ?>