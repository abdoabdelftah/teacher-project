                ...
                <div class="template-demo">
                  ...
                  <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb breadcrumb-custom">
                      ...
                      <li class="breadcrumb-item active" aria-current="page"><span>الامتحانات التى قمت بالاجابة عنها</span></li>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th>اسم الامتحان</th>
                            <th>درجتك فى الامتحان</th>
                            <th>الدرجة النهائية للامتحان</th>
                            
                            <th>اجابتك والاجابة الصحيحة</th>
                        ...
                        <tbody>
                          ...
                          <?php $__currentLoopData = $examname; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(now() >= $dat->lessonsection->end_time ): ?>
                          ...
                          <?php if($dat->lessonsection->section_type == 1 || $dat->lessonsection->section_type == 2): ?>
                            <td>
                              <a href="<?php echo e(url('/student/lexamcheckanswers/'.$dat->lessonsection->id )); ?>" class="btn btn-outline-primary">اضغط لمراجعة الامتحان</a>
                            </td>
                          <?php endif; ?>

                          <?php if($dat->lessonsection->section_type == 6): ?>
                            <td>
                              <a href="<?php echo e(url('/student/ltextexamcheckanswers/'.$dat->lessonsection->id )); ?>" class="btn btn-outline-primary">اضغط لمراجعة الامتحان</a>
                            </td>
                          <?php endif; ?>
              ...
              <div class="table-responsive">
                <table id="order-listing" class="table">
                  ...
                  <tbody>
                    ...
                    <?php if(now() >= $udat->unitexamsection->end_time ): ?>
                    ...
                    <tr>
                      ...
                      <?php if($udat->unitexamsection->type == 3): ?>
                       
                      <td>
                        <a href="<?php echo e(url('/student/uexamcheckanswers/'.$udat->unitexamsection->id )); ?>" class="btn btn-outline-primary">اضغط لمراجعة الامتحان</a>
                      </td>
                    <?php endif; ?> 

                    <?php if($udat->unitexamsection->type == 4): ?>
                       
                    <td>
                      <a href="<?php echo e(url('/student/utextexamcheckanswers/'.$udat->unitexamsection->id )); ?>" class="btn btn-outline-primary">اضغط لمراجعة الامتحان</a>
                    </td>
                  <?php endif; ?> 
...
<script src="<?php echo e(asset('assets/js/dropzone.js')); ?>"></script>
            ...
            <?php /**PATH /home/u580293580/domains/mrkhairy.com/public_html/laravel/resources/views/student/studentresults.blade.php ENDPATH**/ ?>