...
.circle {
  ...
  <!---------------------------------------------Start main here ------------------------------------------------------------------>
   ...
   <!-------------------------------Start Content here ---------------------->
    ...
    <form method="POST" id="myform" class="pt-3" action="<?php echo e(route('post.unitexam')); ?>">
      <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/student/unitexamstart.blade.php ENDPATH**/ ?>