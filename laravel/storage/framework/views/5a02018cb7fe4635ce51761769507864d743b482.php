   ...
   <!-------------------------------Start Content here ---------------------->
    ...
    <div class="col-md-12 grid-margin">
      <div class="card">
        ...
        <br>
        <a class="btn btn-block btn-primary " style="color:blue; font-size:30px;" href="<?php echo e(url('/grade/'.$gradeid.'/unit/'.$unitid.'/unitexam/'.$unitexamsectionid.'/start' )); ?>"> اضغط هنا لبدأ الامتحان </a>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <h3  style="color:rgb(11, 109, 255)"> 
         ...
         <center> <h2>  سيتم ظهور نتيجة الامتحان والاجابة النموذجية يوم   <?php echo e(Str::substr($time->end_time , 8, 2)); ?>  من شهر <?php echo e(Str::substr($time->end_time , 5, 2)); ?> الساعة <?php echo e(Str::substr($time->end_time , 11, 5)); ?> <h2> </center>
...
<?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/student/unitexam.blade.php ENDPATH**/ ?>