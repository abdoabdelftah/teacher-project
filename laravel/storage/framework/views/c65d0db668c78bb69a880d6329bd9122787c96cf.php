...
<?php if($dat->hide == 0): ?>    
   ...
   <div class="container py-2">
    <div class="card">
      <div class="row ">
        <div class="col-md-4">
            <img src="<?php echo e(asset('assets/images/icon-student-icon-for-new-student.png')); ?>" width="140" height="130">
          </div>
          <div class="col-md-8 px-3">
            ...
            <div class="card-block px-15">
              <br>
            <a style="text-align:left; " margin="250px" href="<?php echo e(url('grade/'.$dat -> id.'/units')); ?>" class="btn btn-primary">اضغط هنا للدخول</a>
          </div>
...
<?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/student/grades.blade.php ENDPATH**/ ?>