   ...
   <!-------------------------------Start Content here ---------------------->
    ...
    <div class="col-md-12 grid-margin">
      <div class="card">
        ...
        <br>
        <a class="btn btn-block btn-primary " style="color:blue; font-size:30px;" href="{{url('/grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$lessonid.'/lessonsectiontextexam/'.$lessonsectionid.'/start' )}}"> اضغط هنا لبدأ الامتحان </a>
