...
@foreach($data as $dat)
   ...
   <div class="container py-2">
    <div class="card">
      <div class="row ">
        <div class="col-md-4">
            <img src="{{ asset('assets/images/books-icon.png') }}" width="160" height="150">
          </div>
          <div class="col-md-8 px-3">
            ...
            <div class="card-block px-15">
              <br>
            <a style="text-align:left; " margin="250px" href="{{url('grade/'.$urlid.'/unit/'.$dat->id.'/lessons')}}" class="btn btn-primary">اضغط هنا للدخول</a>
          </div>
