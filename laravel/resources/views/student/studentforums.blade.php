                      ...
                      <table id="order-listing" class="table">
                        <thead>
                          <tr>
                            ...
                            <th style="font-size:20px;">جميع الاسئلة التى قمت بسئوالها من قبل
                              @if(empty($data[0]))<br><br> <span style="color:red;">لم تقم بسئوال اى سؤال من قبل فى اى درس</span> @endif</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{url('student/forums/'.$dat -> id.'/forum')}}" class="btn btn-outline-primary">اضغط لرؤية الاجابة</a>
                            </td>
