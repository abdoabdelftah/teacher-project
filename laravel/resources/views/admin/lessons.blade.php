                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{url('admin/delete/lesson/'.$dat -> id)}}" onclick="return confirm('هل انت متأكد من رغبتك فى المسح نهائيا?')" class="btn btn-danger">حذف<i class="fa fa-trash"></i></a>
                            </td>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{url('admin/delete/unitexam/'.$dat -> id)}}" onclick="return confirm('هل انت متأكد من رغبتك فى المسح نهائيا?')" class="btn btn-danger">حذف<i class="fa fa-trash"></i></a>
                            </td>
