                  ...
                  <div class="col-12">
                    <div class="table-responsive">
                      <table id="order-listing" class="table">
                        ...
                        <br>
                        <a href="{{url('admin/lresultsdownload/'. $lessonsection->id)}}" class="btn btn-primary"> اضغط لتحميل ملف Excel بدرجات الطلاب</a>
                        <br>
                        <br>
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="{{url('admin/lcheckanswers/'.$dat->student->id.'/'. $lessonsection->id)}}" class="btn btn-outline-primary"> ورقة الاجابة</a></td>
