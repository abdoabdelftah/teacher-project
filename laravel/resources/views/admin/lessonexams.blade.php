...
<a href="{{url('admin/addlessonexam/'.$urlid)}}" class="btn btn-success">اضافة سؤال</a>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{url('admin/lessonexams/edit/'.$dat -> id)}}" class="btn btn-outline-primary">  تعديل السؤال</a>
                            </td>
