  ...
  <div class="template-demo">
    ...
    <nav aria-label="breadcrumb" role="navigation">
      <ol class="breadcrumb breadcrumb-custom">
        ...
        <li class="breadcrumb-item"><a href="{{url('admin/lessontextexams/'.$lessonsection->id)}}">{{$lessonsection->name}}</a></li>
        ...
        <li class="breadcrumb-item active" aria-current="page"><span>تعديل سؤال</span></li>
                    ...
                    <form method="POST" class="pt-3" enctype="multipart/form-data" action="{{ route('update.lessontextexam') }}">
                      @csrf
