...
<div class="col-sm-6 col-xl-8">
    <div class="card">
                ...
                <div class="d-flex justify-content-between">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="organicSessionsDropdown">
                      <a class="dropdown-item edit-unit" data-unit-id="{{$unit->id}}" href="javascript:void(0);">تعديل</a>
     ...
     <a href="/admin/lessons/{{$unit->id}}"> <img src="{{asset('admin/assets/img/folder.png')}}" alt="" class="mx-auto d-block" >

     <center> <h5 class="mb-1">{{$unit->name}}</h5> @if ($unit->hide == 1) <i class="mdi mdi-eye-off-outline"></i>
...
<div class="modal fade"  id="editGradeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="POST" action="{{ route('update.unit') }}" enctype="multipart/form-data">
            @csrf
...
<div class="modal fade"  id="addGradeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="POST" action="{{ route('store.unit') }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" value ="{{$id}}" name="grade_id" id="unit-id">
        <div class="modal-header">
