                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <button class="btn rounded-pill btn-label-warning waves-effect notify-btn" data-student_id="{{$dat->id}}" data-bs-toggle="modal" data-bs-target="#notifyModal">ارسال اشعار</button>
...
$('.search').keypress(function(e) {
    ...
    $(document).ready(function () {
        ...
        $('.send-notify').click(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("user.notification") }}', // Replace with your notification route
                data: formData,
