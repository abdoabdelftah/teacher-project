...
<span style="color:var(--bs-primary);">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <li class="menu-item">
        <a href="{{route('notify.u')}}" class="menu-link">
      ...
      <li class="menu-item">
        <a href="{{route('front.page')}}" class="menu-link">
      ...
      <li class="menu-item">
        <a href="{{route('guest.complaints')}}" class="menu-link">
          <i class="menu-icon tf-icons mdi mdi-head-dots-horizontal-outline"></i>
          <div data-i18n="الشكاوى والمقترحات">الشكاوى والمقترحات</div>
        </a>
      </li>
...
<nav class="layout-navbar container-fluid navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
        ...
        <div class="navbar-nav align-items-center">
          <div class="nav-item navbar-search-wrapper mb-0">
            <a class="nav-item nav-link search-toggler fw-normal px-0" href="javascript:void(0);">
              ...
              <span class="d-none d-md-inline-block text-muted">@if(isset($search) && !empty($search)) {{$search}} @else بحث @endif</span>
            </a>
          </div>
        </div>
        <!-- /Search -->
                ...
                <div class="row row-bordered overflow-visible g-0">
                  ...
                  <div class="dropdown-shortcuts-item col">
                    <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                      <i class="mdi mdi-account-question-outline fs-4"></i>
                    </span>
                    <a href="/admin/allforums" class="stretched-link">اسئلة الطلاب</a>

                  </div>

                  <div class="dropdown-shortcuts-item col">
                    <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                      <i class="mdi mdi-head-dots-horizontal-outline fs-4"></i>
                    </span>
                    <a href="/admin/guest/complaints" class="stretched-link">الشكاوى والمقترحات</a>
            ...
            <ul class="dropdown-menu dropdown-menu-end py-0">
              ...
              <li class="dropdown-notifications-list scrollable-container">
                <ul class="list-group list-group-flush">
                    @foreach(auth()->guard('admin')->user()->unreadNotifications->sortByDesc('created_at') as $notification)
      ...
      <div class="navbar-search-wrapper search-input-wrapper  d-none">
        <input type="text" class="form-control search-input container-fluid border-0 headSearch" placeholder="بحث بالاسم او رقم الهاتف" @if(isset($search) && !empty($search)) value="{{$search}}" @endif aria-label="Search...">
