...
.image-area img {
  ...
  <!---------------------------------------------Start main here ------------------------------------------------------------------>
   ...
   <!-------------------------------Start Content here ---------------------->
    ...
    <form method="POST" class="pt-3" id="myform" enctype="multipart/form-data" action="{{ route('post.lessontextexam') }}">
      @csrf
        ...
        <div class="card-body">
          ...
          <div class="col-md-10">
            <div class="form-group row">
              ...
              <div class="form-group">
                <label style="font-size: 25px; color:blue;">قم بكتابة الاجابة هنا او قم برفع صورة</label>
                    <textarea class="form-control" rows="10" cols="150" style="border:2px solid blue" name="answer[{{$exa->id}}]" id="answer{{$exa->id}}">  </textarea>
                <br>
            ...
            <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm" style="border: 1px solid blue;">
              <input   name="student_answer_picture[{{$exa->id}}]" type="file" class="form-control border-0" accept="image/*"   >
