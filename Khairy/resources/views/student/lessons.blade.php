        ...
        <div class="col-md-4">
          ...
          <div class="col-md-8 px-3">
            ...
            <div class="card-block px-15">
              <br>
            <a style="text-align:left; " margin="250px" href="{{url('grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$dat->id.'/lessonsections')}}" class="btn btn-primary">اضغط هنا للدخول</a>
          </div>
    ...
    <div class="card">
      <div class="row ">
        <div class="col-md-4">
          ...
          <div class="col-md-8 px-3">
            <div class="card-block px-3">
              <h4 class="card-title">{{$unitdat->name}}</h4>
            ...
            <div class="card-block px-15">
              <br>
              @if($unitdat->type == 3)
            <a style="text-align:left; " margin="250px" href="{{url('grade/'.$gradeid.'/unit/'.$unitid.'/unitexam/'.$unitdat->id)}}" class="btn btn-primary">اضغط هنا للدخول</a>
          @endif

          @if($unitdat->type == 4)
            <a style="text-align:left; " margin="250px" href="{{url('grade/'.$gradeid.'/unit/'.$unitid.'/unittextexam/'.$unitdat->id)}}" class="btn btn-primary">اضغط هنا للدخول</a>
          @endif
