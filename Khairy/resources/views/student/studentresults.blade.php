                    ...
                    <div class="table-responsive">
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          @if($dat->lessonsection->section_type == 1 || $dat->lessonsection->section_type == 2)
                            <td>
                              <a href="{{url('/student/lexamcheckanswers/'.$dat->lessonsection->id )}}" class="btn btn-outline-primary">اضغط لمراجعة الامتحان</a>
                            </td>
                          @endif

                          @if($dat->lessonsection->section_type == 6)
                            <td>
                              <a href="{{url('/student/ltextexamcheckanswers/'.$dat->lessonsection->id )}}" class="btn btn-outline-primary">اضغط لمراجعة الامتحان</a>
                            </td>
                          @endif
                ...
                <table id="order-listing" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      @if($udat->unitexamsection->type == 3)
                       
                      <td>
                        <a href="{{url('/student/uexamcheckanswers/'.$udat->unitexamsection->id )}}" class="btn btn-outline-primary">اضغط لمراجعة الامتحان</a>
                      </td>
                    @endif 

                    @if($udat->unitexamsection->type == 4)
                       
                    <td>
                      <a href="{{url('/student/utextexamcheckanswers/'.$udat->unitexamsection->id )}}" class="btn btn-outline-primary">اضغط لمراجعة الامتحان</a>
                    </td>
                  @endif 
