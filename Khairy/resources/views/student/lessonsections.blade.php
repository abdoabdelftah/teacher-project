...
<img src="{{ asset('assets/images/ask-icon.png') }}" width="180" height="170">
...
<div class="card-block px-15">
 ...
 <a style="text-align:left; " margin="250px" href="{{url('grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$lessonid.'/lessonforums')}}" class="btn btn-primary">اضغط هنا للدخول</a>
    ...
    <div class="card">
      <div class="row ">
        <div class="col-md-4">
          ...
          @if($dat->section_type == 5)
          <img src="{{ asset('assets/images/book-icon.png') }}" width="180" height="170">
          @else
          <img src="{{ asset('assets/images/exam-icon.png') }}" width="180" height="170">
          @endif

          </div>
          <div class="col-md-8 px-3">
            <div class="card-block px-3">
              <h4 class="card-title">{{$dat->name}}</h4>
            ...
            <div class="card-block px-15">
              ...
              @if($dat->section_type == 5)
             <a style="text-align:left; " margin="250px" href="{{url('grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$lessonid.'/lessonsectionlecture/'.$dat->id)}}" class="btn btn-primary">اضغط هنا للدخول</a>
              @endif
          

              @if($dat->section_type == 1)
              <a style="text-align:left; " margin="250px" href="{{url('grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$lessonid.'/lessonsectionhomework/'.$dat->id)}}" class="btn btn-primary">اضغط هنا للدخول</a>
              
              @endif


             @if($dat->section_type == 2)
             <a style="text-align:left; " margin="250px" href="{{url('grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$lessonid.'/lessonsectionexam/'.$dat->id)}}" class="btn btn-primary">اضغط هنا للدخول</a>
                 
             @endif
      
             @if($dat->section_type == 6)
             <a style="text-align:left; " margin="250px" href="{{url('grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$lessonid.'/lessonsectiontextexam/'.$dat->id)}}" class="btn btn-primary">اضغط هنا للدخول</a>
             @endif
