...
class lessonexamsController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('admin.lessonexams', compact('data', 'lessonsection', 'lesson', 'unit', 'grade'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $examid = Exam::max('id');
        return redirect('admin/lessonexams/edit/'.$examid)->with(['message' => 'قم باكمال متطلبات السؤال  ']);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.addlessonexam', compact('mainid', 'lessonsection', 'lesson', 'unit', 'grade'));
    }
    ...
    public function edit($id)
    {
      ...
      //return $data;
        return view('admin.editlessonexam', compact('data', 'lessonsection', 'lesson', 'unit', 'grade'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('admin/lessonexams/'.$exam->lesson_section_id)->with(['message' => ' تم التحديث بنجاح ']);
