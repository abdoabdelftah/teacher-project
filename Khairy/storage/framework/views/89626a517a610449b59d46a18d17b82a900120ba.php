            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md">
                        <div class="card mb-3">
                            <div class="row g-0">
                                <form method="POST" class="pt-3" enctype="multipart/form-data" action="<?php echo e(route('update.pdfExam')); ?>">
                                    <?php echo csrf_field(); ?>
                                ...
                                <embed src="<?php echo e($exam->question); ?>" type="application/pdf" width="100%"
                                    height="600px" />
                                <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.new-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Web-Development\Khairy\Khairy\resources\views/admin/new/pdfExam.blade.php ENDPATH**/ ?>