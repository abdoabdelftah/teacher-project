...
<a href="<?php echo e(url('admin/addlessonexam/'.$urlid)); ?>" class="btn btn-success">اضافة سؤال</a>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo e(url('admin/lessonexams/edit/'.$dat -> id)); ?>" class="btn btn-outline-primary">  تعديل السؤال</a>
                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/admin/lessonexams.blade.php ENDPATH**/ ?>