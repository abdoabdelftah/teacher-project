  ...
  <div class="col-md-12 grid-margin">
    <div class="card">
      <div class="card-body">
        ...
        <form method="POST" class="pt-3" id="myform" enctype="multipart/form-data" action="<?php echo e(route('post.forum')); ?>">
          <?php echo csrf_field(); ?>
<input type="hidden" name="lesson_id" value="<?php echo e($lesson_id); ?>">
<div class="form-group">

  <label style="font-size: 18px; color:blue;">السؤال</label>
  <input name="head" class="form-control" style="border:2px solid blue" name="question" id="answer">  
<br>

</div>
        <div class="form-group">
          <label style="font-size: 25px; color:blue;">قم بكتابة وصف للسؤال او قم برفع صورة</label>
              <textarea class="form-control" rows="10" cols="150" style="border:2px solid blue" name="question" id="answer">  </textarea>
          <br>
...
<script>
  ...
  function myfFunction() {
    document.getElementById("mysubmit").disabled = true;
            ...
            <?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/student/addforum.blade.php ENDPATH**/ ?>