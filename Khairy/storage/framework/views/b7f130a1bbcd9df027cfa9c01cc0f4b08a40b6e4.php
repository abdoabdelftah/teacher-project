      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('admin/students')); ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('admin/grades')); ?>">
...
<?php /**PATH /home/u580293580/domains/mrkhairy.com/public_html/laravel/resources/views/admin/layouts/texteditor.blade.php ENDPATH**/ ?>