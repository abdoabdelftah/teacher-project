...
<div class="row g-4 mb-4">
    ...
    <h4>الوحدات</h4>
      ...
      <button type="button" class="custom-btn" data-bs-toggle="modal" data-bs-target="#addGradeModal">اضافة وحدة</button>
...
<div class="col-sm-6 col-xl-8">
    <div class="card">
                ...
                <div class="d-flex justify-content-between">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="organicSessionsDropdown">
                      <a class="dropdown-item edit-unit" data-unit-id="<?php echo e($unit->id); ?>" href="javascript:void(0);">تعديل</a>
     ...
     <a href="/admin/lessons/<?php echo e($unit->id); ?>"> <img src="<?php echo e(asset('admin/assets/img/folder.png')); ?>" alt="" class="mx-auto d-block" >

     <center> <h5 class="mb-1"><?php echo e($unit->name); ?></h5> <?php if($unit->hide == 1): ?> <i class="mdi mdi-eye-off-outline"></i>
...
<div class="modal fade"  id="editGradeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="POST" action="<?php echo e(route('update.unit')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="id" value ="" id="unit-id">
        <div class="modal-header">
          <h4 class="modal-title" id="exampleModalLabel1">تعديل وحدة</h4>
...
<div class="modal fade"  id="addGradeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="POST" action="<?php echo e(route('store.unit')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <input type="hidden" value ="<?php echo e($id); ?>" name="grade_id" id="unit-id">
        <div class="modal-header">
...
<?php echo $__env->make('admin.layouts.new-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Web-Development\Khairy\Khairy\resources\views/admin/new/units.blade.php ENDPATH**/ ?>