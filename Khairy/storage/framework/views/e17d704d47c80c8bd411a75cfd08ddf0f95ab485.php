...
.circle {
  ...
  <body class="rtl">
   ...
   <a href="<?php echo e(url('/grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$lessonid.'/lessonforums/add')); ?>" class="btn btn-success">اضافة سؤال فى هذا الدرس</a>
                      ...
                      <table id="order-listing" class="table">
                        <thead>
                          <tr>
                            ...
                            <th style="font-size:20px;">جميع اسئلة الطلاب فى هذا الدرس
                              <?php if(empty($data[0])): ?><br><br> <span style="color:red;">لا يوجد اى اسئلة فى هذا الدرس</span> <?php endif; ?></th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo e(url('/grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$lessonid.'/lessonforum/'.$dat -> id.'/one')); ?>" class="btn btn-outline-primary">اضغط لرؤية الاجابة</a>
                            </td>
...
<script src="<?php echo e(asset('assets/js/dropzone.js')); ?>"></script>
            ...
            <?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/student/forums.blade.php ENDPATH**/ ?>