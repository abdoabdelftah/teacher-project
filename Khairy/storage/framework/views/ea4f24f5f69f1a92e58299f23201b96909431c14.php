...
.image-area img {
  ...
  <!---------------------------------------------Start main here ------------------------------------------------------------------>
   ...
   <!-------------------------------Start Content here ---------------------->
    ...
    <form method="POST" class="pt-3" id="myform" enctype="multipart/form-data" action="<?php echo e(route('post.lessontextexam')); ?>">
      <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u580293580/domains/mrkhairy.com/public_html/laravel/resources/views/student/lessonsectiontextexamstart.blade.php ENDPATH**/ ?>