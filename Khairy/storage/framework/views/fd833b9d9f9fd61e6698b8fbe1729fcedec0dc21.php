                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <td><?php if($dat->hide == 0): ?> ظاهر <?php else: ?> مخفى <?php endif; ?></td>
                            ...
                            <td>
                              <a href="<?php echo e(url('admin/delete/lessonsection/'.$dat -> id)); ?>" onclick="return confirm('هل انت متأكد من رغبتك فى المسح نهائيا?')" class="btn btn-danger">حذف<i class="fa fa-trash"></i></a>
                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/admin/lessonsections.blade.php ENDPATH**/ ?>