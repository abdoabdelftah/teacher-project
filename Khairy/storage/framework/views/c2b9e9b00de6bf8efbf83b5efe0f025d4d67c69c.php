...
<a href="<?php echo e(url('admin/addunittextexam/'.$urlid)); ?>" class="btn btn-success">اضافة سؤال</a>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo e(url('admin/unittextexams/edit/'.$dat -> id)); ?>" class="btn btn-outline-primary">  تعديل السؤال</a>
                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u580293580/domains/mrkhairy.com/public_html/laravel/resources/views/admin/unittextexams.blade.php ENDPATH**/ ?>