                  ...
                  <div class="col-12">
                    <div class="table-responsive">
                      <table id="order-listing" class="table">
                        ...
                        <br>
                        <a href="<?php echo e(url('admin/uresultsdownload/'. $unitexamsection->id)); ?>" class="btn btn-primary"> اضغط لتحميل ملف Excel بدرجات الطلاب</a>
                        <br>
                        <br>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="<?php echo e(url('admin/ucheckanswers/'.$dat->student->id.'/'. $unitexamsection->id)); ?>" class="btn btn-outline-primary"> ورقة الاجابة</a></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/admin/unitsectionanswered.blade.php ENDPATH**/ ?>