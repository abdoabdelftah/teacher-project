  ...
  <div class="template-demo">
    ...
    <nav aria-label="breadcrumb" role="navigation">
      <ol class="breadcrumb breadcrumb-custom">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(url('admin/lessonexams/'.$lessonsection->id)); ?>"><?php echo e($lessonsection->name); ?></a></li>
        ...
        <li class="breadcrumb-item active" aria-current="page"><span>اضافة سؤال</span></li>
                    ...
                    <form method="POST" class="pt-3" action="<?php echo e(route('store.lessonexam')); ?>">
                      <?php echo csrf_field(); ?>
                  ...
                  <select name="choose_type" class="form-control" id="exampleFormControlSelect2">
                    ...
                    <input type="hidden" name="type" value ="2" class="form-control"  aria-label="Username">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/admin/addlessonexam.blade.php ENDPATH**/ ?>