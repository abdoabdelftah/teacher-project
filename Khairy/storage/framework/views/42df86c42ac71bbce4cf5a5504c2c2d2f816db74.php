                ...
                <div class="template-demo">
                  ...
                  <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb breadcrumb-custom">
                      ...
                      <li class="breadcrumb-item active" aria-current="page"><span>الدروس</span></li>
        ...
        <div class="col-md-4">
          ...
          <div class="col-md-8 px-3">
            ...
            <div class="card-block px-15">
              <br>
            <a style="text-align:left; " margin="250px" href="<?php echo e(url('grade/'.$gradeid.'/unit/'.$unitid.'/lesson/'.$dat->id.'/lessonsections')); ?>" class="btn btn-primary">اضغط هنا للدخول</a>
          </div>
...
<?php if(!empty($unitdata[0])): ?>
<?php $__currentLoopData = $unitdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unitdat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="card">
      <div class="row ">
        <div class="col-md-4">
          ...
          <div class="col-md-8 px-3">
            <div class="card-block px-3">
              <h4 class="card-title"><?php echo e($unitdat->name); ?></h4>
            ...
            <div class="card-block px-15">
              <br>
              <?php if($unitdat->type == 3): ?>
            <a style="text-align:left; " margin="250px" href="<?php echo e(url('grade/'.$gradeid.'/unit/'.$unitid.'/unitexam/'.$unitdat->id)); ?>" class="btn btn-primary">اضغط هنا للدخول</a>
          <?php endif; ?>

          <?php if($unitdat->type == 4): ?>
            <a style="text-align:left; " margin="250px" href="<?php echo e(url('grade/'.$gradeid.'/unit/'.$unitid.'/unittextexam/'.$unitdat->id)); ?>" class="btn btn-primary">اضغط هنا للدخول</a>
          <?php endif; ?>
...
<?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/student/lessons.blade.php ENDPATH**/ ?>