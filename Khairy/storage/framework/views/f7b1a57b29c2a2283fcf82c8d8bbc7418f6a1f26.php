           ...
           <div class="form-group row">
             ...
             <div class="col-sm-7">
               <div class="form-check">
                 <label  class=" form-check-label" <?php if($exam->right_answer == "choose1"): ?> style="border-radius:60%; border:solid"  <?php endif; ?>>

                   <input type="radio" class="form-check-input"  value="choose1" disabled> <?php echo e($exam->choose1); ?></label>
             ...
             <div class="col-sm-4">
               <div class="form-check">
                 <label class="form-check-label" <?php if($exam->right_answer == "choose2"): ?> style="border-radius:60%; border:solid" <?php endif; ?>>
                   <input type="radio" class="form-check-input"  value="choose2" disabled> <?php echo e($exam->choose2); ?> </label>
               </div>
             </div>
             ...
             <div class="col-sm-7">
               <div class="form-check">
                 <label class="form-check-label" <?php if($exam->right_answer == "choose3"): ?> style="border-radius:60%; border:solid " <?php endif; ?>>
                   <input type="radio" class="form-check-input" value="choose3" disabled> <?php echo e($exam->choose3); ?>   </label>
             ...
             <div class="col-sm-4">
               <div class="form-check">
                 <label class="form-check-label" <?php if($exam->right_answer == "choose4"): ?> style="border-radius:60%; border:solid " <?php endif; ?>>
                   <input type="radio" class="form-check-input"  value="choose4" disabled> <?php echo e($exam->choose4); ?> </label>
               </div>
             </div>
           </div>
         </div>
         ...
         <div class="col-sm-7">
           <div class="form-check">
             <label class="form-check-label" >
               ...
               <div class="col-md-4" >
                 <img src="<?php echo e($exam->choose1); ?>" width="200px" height="100px"  <?php if($exam->right_answer == "choose1"): ?> style="border-radius:60%; border:solid 3px;padding:12px" <?php endif; ?>>
               </div>
         ...
         <div class="col-sm-4">
           <div class="form-check">
             <label class="form-check-label" >
               ...
               <div class="col-md-4">
                 <img src="<?php echo e($exam->choose2); ?>"  width="200px" height="100px" <?php if($exam->right_answer == "choose2"): ?> style="border-radius:60%; border:solid 3px;padding:12px" <?php endif; ?>>
               </div>
         ...
         <div class="col-sm-7">
           <div class="form-check">
             <label class="form-check-label" >
               ...
               <div class="col-md-4">
                 <img src="<?php echo e($exam->choose3); ?>" width="200px" height="100px" <?php if($exam->right_answer == "choose3"): ?> style="border-radius:60%; border:solid 3px;padding:12px" <?php endif; ?>>
               </div>
         ...
         <div class="col-sm-4">
           <div class="form-check">
             <label class="form-check-label">
               ...
               <div class="col-md-4">
                 <img src="<?php echo e($exam->choose1); ?>"  width="200px" height="100px"  <?php if($exam->right_answer == "choose4"): ?> style="border-radius:60%; border:solid 3px;padding:12px" <?php endif; ?>>
               </div>
...
<?php echo $__env->make('admin.layouts.new-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Web-Development\Khairy\Khairy\resources\views/admin/new/exam.blade.php ENDPATH**/ ?>