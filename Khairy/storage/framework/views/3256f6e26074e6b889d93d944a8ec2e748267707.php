            ...
            <div class="row">
                <div class=" col-12 ">
                    <ul class="list-group review-list">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item border-3 shadow rounded">
                                <div class="d-flex">
                                    <img width="50px" src="<?php echo e(asset('assets/images/ask-icon.png')); ?>"
                                        class="avatar rounded">
                                    <div class="review-right col-sm-9">
                                        <span class="author-name"><?php echo e($forum->student->name); ?></span>
                                        <div class="time">
                                            <a
                                                href="#"><?php echo e(\Carbon\Carbon::parse($forum->created_at)->diffForHumans()); ?></a>
                                        </div>
                                    ...
                                    <?php $__currentLoopData = $forum->forumcomments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="d-flex my-replay-1">
                                            <div class="line-img-con">
                                                <img src="<?php echo e($comment->commentor == 1 ? asset('assets/images/faces/face8.jpg') : asset('assets/images/ask-icon.png')); ?>"
                                                    alt class="your-imag">
                                            </div>
                                            <div class="replay-img-info col-sm-9">
                                                <div class="your-replay-con">
                                                    <h1 class="stud-name">
                                                        <?php echo e($comment->commentor == 1 ? 'استاذ محمد خيرى' : $forum->student->name); ?>
                                ...
                                <?php if($forum->student->id == auth()->user()->id): ?>
                                    <div class="chat-history-footer card border-3 shadow">
                                        <form class="form-send-message d-flex justify-content-between align-items-center"
                                            id="comment-form-<?php echo e($forum->id); ?>">
                                            ...
                                            <div class="message-actions d-flex align-items-center">
                                                <label for="attach-doc-<?php echo e($forum->id); ?>" class="form-label mb-0">
                                                    ...
                                                    <input type="file" id="attach-doc-<?php echo e($forum->id); ?>"
                                                        name="picture" hidden>
                                                </label>
                                                <button type="button" class="btn btn-primary d-flex send-msg-btn"
                                                    onclick="submitForm(<?php echo e($forum->id); ?>)">
...
<?php echo $__env->make('student.layouts.new-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Web-Development\Khairy\Khairy\resources\views/student/new/allForums.blade.php ENDPATH**/ ?>