...
<!-- Mirrored from www.bootstrapdash.com/demo/stellar-admin/jquery/template/demo_1/pages/layout/rtl-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jan 2021 01:25:10 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="../../index.html">
            <img src="<?php echo e(asset('assets/images/logo.svg')); ?>" alt="logo" class="logo-dark" />
            <img src="<?php echo e(asset('assets/images/logo-light.svg')); ?>" alt="logo-light" class="logo-light">
          </a>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item navbar-brand-mini-wrapper">
              <a class="nav-link navbar-brand brand-logo-mini" href="../../index.html"><img src="<?php echo e(asset('assets/images/logo-mini.svg')); ?>" alt="logo" /></a>
            </li>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex mt-4 py-3 border-bottom">
                      <img class="img-sm rounded-circle" src="<?php echo e(asset('assets/images/faces/face3.jpg')); ?>" alt="profile image">
                    ...
                    <div class="d-flex py-3 border-bottom">
                      <img class="img-sm rounded-circle" src="<?php echo e(asset('assets/images/faces/face2.jpg')); ?>">
                      <div class="wrapper mr-2">
                    ...
                    <div class="d-flex py-3 border-bottom">
                      <img class="img-sm rounded-circle" src="<?php echo e(asset('assets/images/faces/face4.jpg')); ?>" alt="profile image">
                      <div class="wrapper mr-2">
                    ...
                    <div class="d-flex py-3  border-bottom">
                      <img class="img-sm rounded-circle" src="<?php echo e(asset('assets/images/faces/face8.jpg')); ?>">
                      <div class="wrapper mr-2">
                    ...
                    <div class="d-flex pt-3">
                      <img class="img-sm rounded-circle" src="<?php echo e(asset('assets/images/faces/face7.jpg')); ?>">
                      <div class="wrapper mr-2">
                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="<?php echo e(asset('assets/images/faces/face1.jpg')); ?>" alt="profile image"> Katie Holmes </td>
                            <td>$3621</td>
                            <td><img src="<?php echo e(asset('assets/images/dashboard/alipay.png')); ?>" alt="alipay" class="gateway-icon ml-2"> alipay</td>
                            <td>04 يونيو 2019</td>
                            <td>18 يوليو 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="<?php echo e(asset('assets/images/faces/face2.jpg')); ?>" alt="profile image"> Minnie Copeland </td>
                            <td>$6245</td>
                            <td><img src="<?php echo e(asset('assets/images/dashboard/paypal.png')); ?>" alt="alipay" class="gateway-icon ml-2"> باي بال</td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="<?php echo e(asset('assets/images/faces/face3.jpg')); ?>" alt="profile image"> Rodney Sims </td>
                            <td>$9265</td>
                            <td><img src="<?php echo e(asset('assets/images/dashboard/alipay.png')); ?>" alt="alipay" class="gateway-icon ml-2"> alipay</td>
                            <td>12 dec 2019</td>
                            <td>26 أغسطس 2019</td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="<?php echo e(asset('assets/images/faces/face4.jpg')); ?>" alt="profile image"> Carolyn Barker </td>
                            <td>$2263</td>
                            <td><img src="<?php echo e(asset('assets/images/dashboard/alipay.png')); ?>" alt="alipay" class="gateway-icon ml-2"> alipay</td>
...
<!-- Mirrored from www.bootstrapdash.com/demo/stellar-admin/jquery/template/demo_1/pages/layout/rtl-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jan 2021 01:25:10 GMT -->
</html><?php /**PATH /home/u580293580/domains/mrkhairy.com/public_html/laravel/resources/views/admin/layouts/main-template.blade.php ENDPATH**/ ?>