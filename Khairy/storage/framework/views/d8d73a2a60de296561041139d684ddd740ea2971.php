...
<div class="col-sm-6 col-xl-8">
    <div class="card">
                ...
                <div class="d-flex justify-content-between">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="organicSessionsDropdown">
                      <a class="dropdown-item edit-lesson" data-lesson-id="<?php echo e($lesson->id); ?>" href="javascript:void(0);">تعديل</a>
     ...
     <a href="/admin/lessonsections/<?php echo e($lesson->id); ?>"> <img src="<?php echo e(asset('admin/assets/img/folder.png')); ?>" alt="" class="mx-auto d-block" >

     <center> <h5 class="mb-1"><?php echo e($lesson->name); ?></h5> <?php if($lesson->hide == 1): ?> <i class="mdi mdi-eye-off-outline"></i>
...
<div class="modal fade"  id="editGradeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="POST" action="<?php echo e(route('update.lesson')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<div class="modal fade"  id="addGradeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="POST" action="<?php echo e(route('store.lesson')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <input type="hidden" value ="<?php echo e($id); ?>" name="unit_id" id="lesson-id">
        <div class="modal-header">
...
<?php echo $__env->make('admin.layouts.new-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Web-Development\Khairy\Khairy\resources\views/admin/new/lessons.blade.php ENDPATH**/ ?>