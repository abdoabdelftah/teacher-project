...
<div class="row g-4 mb-4">
    ...
    <h4> تطور الطالب <?php echo e($student->name); ?></h4>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                ...
                                <a href="<?php echo e(url('admin/student/edit/'.$student->id)); ?>" class="btn rounded-pill btn-label-info waves-effect">تعديل الطالب</a>
...
<?php echo $__env->make('admin.layouts.new-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Web-Development\Khairy\Khairy\resources\views/admin/new/studentProgress.blade.php ENDPATH**/ ?>