            ...
            <div class="container">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(route('updateInfoFront.page')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php $__currentLoopData = $lectures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lecture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="card h-100">
                                <a href="/admin/front-page/delete/<?php echo e($lecture->id); ?>" class="btn-close"></a>
                ...
                <div class="swiper" id="swiper-reviews2">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="card h-100">
                                <a href="/admin/front-page/delete/<?php echo e($baqa->id); ?>" class="btn-close"></a>
                    ...
                    <div class="col-lg-5">
                            ...
                            <div class="d-flex mt-2 gap-3">
                                <div class="form-floating form-floating-outline w-px-250">
                                    ...
                                    <input type="text" name = "data" class="form-control bg-transparent text-white"
                                        id="newsletter-1" placeholder="Your email" value="<?php echo e($information[2]->data); ?>"/>
                        ...
                        <form method="POST" action="<?php echo e(route('updateInfoFront.page')); ?>" enctype="multipart/form-data">
                            ...
                            <div class="d-flex mt-2 gap-3">
                                <div class="form-floating form-floating-outline w-px-250">
                                    <input type="text" name ="data" class="form-control bg-transparent text-white"
                                        id="newsletter-1" placeholder="رابط الفيسبوك" value="<?php echo e($information[3]->data); ?>"/>
...
<div class="modal fade"  id="addAlertModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="POST" action="<?php echo e(route('updateNewsFront.page')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
