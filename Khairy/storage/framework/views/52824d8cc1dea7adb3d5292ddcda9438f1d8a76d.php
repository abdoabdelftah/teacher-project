...
unset($__errorArgs, $__bag); ?>
                        <form method="POST" class="pt-3" action="<?php echo e(route('save.student.login')); ?>">
                            ...
                            <div class="mb-3 d-flex justify-content-between">
                                <a href="https://api.whatsapp.com/send?phone=<?php echo e($information[2]->data); ?>&text=حسابى لا يعمل"
                        ...
                        <p class="text-center">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=<?php echo e($information[2]->data); ?>&text=حجز طالب جديد"
                                target="_blank">
                ...
                <!-- /Login -->
                <img alt="mask"
                    src="<?php echo e(asset('admin/assets/img/illustrations/auth-basic-login-mask-light.png')); ?>"
...
<!-- beautify ignore:end -->
<?php /**PATH E:\Web-Development\Khairy\Khairy\resources\views/login.blade.php ENDPATH**/ ?>