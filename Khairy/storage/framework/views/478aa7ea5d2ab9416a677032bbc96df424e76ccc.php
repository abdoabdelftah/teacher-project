   ...
   <div class="col-md-12 grid-margin">
    <div class="card">
      ...
      <h3  style="color:rgb(11, 109, 255); border-radius:30%; border:solid green 3px;padding:50px"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         لقد حصل الطالب على <?php echo e($studentanswer->sum('points')); ?> من <?php echo e($exam->sum('points')); ?> </h3>
              ...
              <div class="col-sm-7">
                <div class="form-check">
                  <label class="form-check-label" >
                    ...
                    <div class="col-md-4" >
                      <img src="<?php echo e($exa->choose1); ?>" width="200px" height="100px"  <?php if($exa->right_answer == "choose1"): ?> style="border-radius:60%; border:solid <?php if($exa->right_answer == $studentanswer[$i]->student_answer): ?> green <?php else: ?> red <?php endif; ?>  3px;padding:12px" <?php endif; ?>>
                    </div>
              ...
              <div class="col-sm-4">
                <div class="form-check">
                  <label class="form-check-label" >
                    ...
                    <div class="col-md-4">
                      <img src="<?php echo e($exa->choose2); ?>"  width="200px" height="100px" <?php if($exa->right_answer == "choose2"): ?> style="border-radius:60%; border:solid <?php if($exa->right_answer == $studentanswer[$i]->student_answer): ?> green <?php else: ?> red <?php endif; ?>  3px;padding:12px" <?php endif; ?>>
                    </div>
              ...
              <div class="col-sm-7">
                <div class="form-check">
                  <label class="form-check-label" >
                    ...
                    <div class="col-md-4">
                      <img src="<?php echo e($exa->choose3); ?>" width="200px" height="100px" <?php if($exa->right_answer == "choose3"): ?> style="border-radius:60%; border:solid <?php if($exa->right_answer == $studentanswer[$i]->student_answer): ?> green <?php else: ?> red <?php endif; ?>  3px;padding:12px" <?php endif; ?>>
                    </div>
              ...
              <div class="col-sm-4">
                <div class="form-check">
                  <label class="form-check-label">
                    ...
                    <div class="col-md-4">
                      <img src="<?php echo e($exa->choose1); ?>"  width="200px" height="100px"  <?php if($exa->right_answer == "choose4"): ?> style="border-radius:60%; border:solid <?php if($exa->right_answer == $studentanswer[$i]->student_answer): ?> green <?php else: ?> red <?php endif; ?>  3px;padding:12px" <?php endif; ?>>
                    </div>
...
<?php /**PATH /home/u580293580/domains/eazythink.com/public_html/laravel/resources/views/admin/ucheckanswers.blade.php ENDPATH**/ ?>