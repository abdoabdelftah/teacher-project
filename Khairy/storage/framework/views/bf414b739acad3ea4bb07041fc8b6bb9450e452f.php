...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row g-4 mb-4">
        ...
        <?php if(count($section->sectionFollowup) > 0 && $section->sectionFollowup[0]->done == 1): ?>
            <div class="card">
                <div class="card-body">
                    <?php if(count($section->sectionFollowup) > 0 &&
                    ...
                    <?php elseif(count($section->sectionFollowup) > 0 &&
                            $section->sectionFollowup[0]->done == 1 &&
                        ...
                        <center>
                            <div class="row"
                                ...
                                <h3 style="color: rgb(11, 109, 255);">
                                    نتيجتك هى : <?php echo e($exam->studentexamanswers[0]->points); ?> من <?php echo e($exam->points); ?> </h3>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <?php if($exam && !empty($exam->question)): ?>
                        <embed src="<?php echo e($exam->question); ?>" type="application/pdf" width="100%" height="600px" />
                    <?php endif; ?>
                    ...
                    <?php if(count($exam->studentexamanswers) > 0 &&
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingDeliveryOptions<?php echo e($exam->id); ?>">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapseDeliveryOptions<?php echo e($exam->id); ?>" aria-expanded="false"
                                        aria-controls="collapseDeliveryOptions<?php echo e($exam->id); ?>"><b> اجابتك
                                        </b></button>
                                </h2>
                                <div id="collapseDeliveryOptions<?php echo e($exam->id); ?>" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            ...
                                            <?php if($exam->studentexamanswers[0] && !empty($exam->studentexamanswers[0]->student_answer_picture)): ?>
                                                <embed src="<?php echo e($exam->studentexamanswers[0]->student_answer_picture); ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <?php if(count($exam->studentexamanswers) > 0 && !empty($exam->studentexamanswers[0]->right_answer_pic)): ?>
                                                <div class="row g-0" id="displayI">
                                                    ...
                                                    <div class="col-md-4"
                                                        ...
                                                        <embed src="<?php echo e($exam->studentexamanswers[0]->right_answer_pic); ?>"
                                                            type="application/pdf" width="100%" height="600px" />
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <input id="roundedInput" class="form-control rounded-pill"
                                                    value="<?php echo e($exam->points); ?> من <?php echo e($exam->studentexamanswers[0]->points); ?>"
...
<?php echo $__env->make('student.layouts.exam-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Web-Development\Khairy\Khairy\resources\views/student/new/pdf-exam.blade.php ENDPATH**/ ?>